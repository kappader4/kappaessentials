...
public class TokenTopCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        sender.sendMessage(ChatColor.GOLD + "" + ChatColor.BOLD + "Top 10 Tokens:");
        ...
        for (Map.Entry<UUID, Integer> entry : TokenManager.getTopTokens(10)) {
            ...
            sender.sendMessage(ChatColor.GOLD + "" + ChatColor.BOLD + rank + ". " +
                    ChatColor.GRAY + name + " - " + ChatColor.YELLOW + formatted + " Tokens");
            rank++;
        }
        return true;
    }
    ...
    private String getPlayerName(UUID uuid) {
        ...
        return uuid.toString().substring(0, 8); // fallback to short UUID
    }
